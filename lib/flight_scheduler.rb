...
module FlightScheduler
  ...
  autoload(:Connection, 'flight_scheduler/connection')
  autoload(:ConnectionRegistry, 'flight_scheduler/connection_registry')
  autoload(:EventDispatcher, 'flight_scheduler/event_dispatcher')
