# Contributing to FlurmAPI

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to FlurmAPI? Welcome! Please read this
...
You can help FlurmAPI by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flurm-api/issues?state=open)
...
If you find a bug - behaviour of FlurmAPI code or documentation
...
[GitHub issue tracker for FlurmAPI](https://github.com/openflighthpc/flurm-api/issues/new)
to report the issue.
...
We want to improve the quality of FlurmAPI and good bug reports are
...
FlurmAPI is Open Source and comes without warranty.
...
FlurmAPI in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of FlurmAPI and really improve it. The more
...
applied to FlurmAPI itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flurm-api). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the FlurmAPI developers also have their regular
